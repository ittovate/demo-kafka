package com.example.kafkademo.log;
...
import static com.example.kafkademo.constant.AspectConstant.AFTER_RETURN_MESSAGE;
import static com.example.kafkademo.constant.AspectConstant.AFTER_THROW_MESSAGE;
import static com.example.kafkademo.constant.AspectConstant.BEFORE_MESSAGE;
import static com.example.kafkademo.util.AspectUtil.getClassName;
import static com.example.kafkademo.util.AspectUtil.getMethodArgs;
import static com.example.kafkademo.util.AspectUtil.getMethodName;
...
public class LoggingAspect {
     ...
     * </p>
     *
     * @param joinPoint The {@code ProceedingJoinPoint} which contains details about the method being executed,                  such as the class name, method name, and arguments.
     * @return The result of the method execution.
     * @throws Throwable If the method being logged throws an exception, it is propagated after logging the error.
     */
    @Around("execution(* com.example.kafkademo.*.*.*(..))")
